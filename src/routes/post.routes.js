...
import { createPost, getRecentPosts, getPostById, searchPosts, updatePost, deletePost, createComment, getPostComments, addLike, removeLike, getLikes, getPostsByMovieId} from "../controllers/post.controllers.js";
...
router.get('/movies/:movieId/posts', authenticateToken, getPostsByMovieId)
