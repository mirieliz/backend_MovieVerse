...
import { createPost, getRecentPosts, getPostById, getUserPostMyPost, userUpdatePost, getOtherUserPost} from "../controllers/post.controllers.js";
...
router.get('/user/me/posts',validatePost(),getUserPostMyPost);

// this endpoints don't had validations yet
